...
public class GetAccountStatementUseCase {
    ...
    public List<TransactionDomain> getAccountStatmentByRecipient(Integer accountId, Integer recipientId){
        return transactionGateway.getAccountStatmentByRecipient(accountId, recipientId);
    }
